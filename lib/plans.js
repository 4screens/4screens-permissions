...
plans.engageHub['engagehub-basic-annual'] = _.merge({}, ehConfig.defaults, ehConfig.basic, { planId: 'engagehub-basic-annual', level: 11, price: 1200, billingTime: 12 });

plans.engageHub['engagehub-standard'] = _.merge({}, ehConfig.defaults, ehConfig.standard, { level: 20 });
plans.engageHub['engagehub-standard-annual'] = _.merge({}, ehConfig.defaults, ehConfig.standard, { planId: 'engagehub-standard-annual', level: 21, price: 2400, billingTime: 12 });
