...
plans.youengage.appsumo_ltd_starter = _.merge({}, yConfig.defaults, yConfig.enterprise, { planId: 'appsumo_ltd_starter',level: 11 });
plans.youengage.appsumo_ltd_professional = _.merge({}, yConfig.defaults, yConfig.enterprise, { planId: 'appsumo_ltd_professional',level: 21 });
plans.youengage.appsumo_ltd_business = _.merge({}, yConfig.defaults, yConfig.enterprise, { planId: 'appsumo_ltd_business',level: 31 });
plans.youengage.appsumo_ltd_business_4 = _.merge({}, yConfig.defaults, yConfig.enterprise, { planId: 'appsumo_ltd_business_4',level: 32 });
plans.youengage.appsumo_ltd_business_5 = _.merge({}, yConfig.defaults, yConfig.enterprise, { planId: 'appsumo_ltd_business_5',level: 33 });
