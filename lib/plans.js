...
plans.engageNow['engagenow-basic-annual'] = _.merge({}, enConfig.defaults, enConfig.basic, { planId: 'engagenow-basic-annual', level: 11, price: 720, billingTime: 12 });

plans.engageNow['engagenow-standard'] = _.merge({}, enConfig.defaults, enConfig.standard, { level: 20 });
plans.engageNow['engagenow-standard-annual'] = _.merge({}, enConfig.defaults, enConfig.standard, { planId: 'engagenow-standard-annual', level: 21, price: 1680, billingTime: 12 });
...
plans.engageHub['engagehub-basic-annual'] = _.merge({}, ehConfig.defaults, ehConfig.basic, { planId: 'engagehub-basic-annual', level: 11, price: 720, billingTime: 12 });

plans.engageHub['engagehub-standard'] = _.merge({}, ehConfig.defaults, ehConfig.standard, { level: 20 });
plans.engageHub['engagehub-standard-annual'] = _.merge({}, ehConfig.defaults, ehConfig.standard, { planId: 'engagehub-standard-annual', level: 21, price: 1680, billingTime: 12 });

plans.engageHub['engagehub-pro'] = _.merge({}, ehConfig.defaults, ehConfig.pro, { level: 30 });
plans.engageHub['engagehub-pro-annual'] = _.merge({}, ehConfig.defaults, ehConfig.pro, { planId: 'engagehub-pro-annual', level: 31, price: 4800, billingTime: 12 });
